...
from RULE.rules import check_transactions
...
path = {
    'graphs_info': 'data/intermediate_data/graphs_info.pkl',
    'cards_label': 'data/intermediate_data/cards_label.pkl',
    'new_all_cards': 'data/intermediate_data/new_all_cards.pkl',
    'graphs_features': 'data/intermediate_data/graphs_features.pkl',
    'graphs_adj': 'data/intermediate_data/graphs_adj.pkl',
    'state_dict_dir': "data/intermediate_result",
    'pred_error_cards': 'data/pred_info/pred_error_cards.txt',
    'pred_cards': 'data/pred_info/pred_cards.txt',
    'high_risk': 'data/high_risk_cards.txt',
    'detection_cut_result': r'D:/大三上/反洗钱（信安）/flaskProject/data/detection_cut_result',
    'nn2rule': 'data/intermediate_data/nn2rule.pkl'
}
...
def predict(card_num, mode=1):
    ...
    if mode == 1:
        ...
        with open(path['nn2rule'], 'rb') as f:
            ...
            with open('data/trans_flagged/{}.json'.format(card_num), 'w', encoding='utf-8') as file:
