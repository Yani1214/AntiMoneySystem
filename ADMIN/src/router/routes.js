          ...
          children: [
            {
              ...
              meta: {
                ...
                icon: "yonghuguanli",
                requiresAuth: false,
                perms: ["sys:user:list", "sys:user:create", "sys:user:update", "sys:user:delete", "sys:user:reset"]
              },
            ...
            },
            {
              ...
              meta: {
                ...
                icon: "yonghuguanli",
                requiresAuth: false,
                perms: ["sys:permissions:list", "sys:permissions:create", "sys:permissions:update", "sys:permissions:delete", "sys:permissions:reset"]
              },
            ...
            },
            {
              ...
              meta: {
                ...
                icon: "yonghuguanli",
                requiresAuth: false,
                perms: ["sys:optLog:list", "sys:optLog:create", "sys:optLog:update", "sys:optLog:delete", "sys:optLog:deleteAll", "sys:optLog:export"]
              },
            ...
            },
            {
              ...
              meta: {
                ...
                icon: "yonghuguanli",
                requiresAuth: false,
                perms: ["sys:resources:list", "sys:resources:create", "sys:resources:update", "sys:resources:delete"]
              },
