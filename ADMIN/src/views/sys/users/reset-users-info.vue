<template>
  <section class="zy-get">
    <a-form :model="state.form"
      ...
      >
        <a-input v-model="state.form.password" type="password" disabled allowClear placeholder="请输入密码"/>
      </a-form-item>
      <a-form-item label="新密码"
                   name="newPassword"
                   :rules="[{ required: true, message: '请输入新密码!' }]"
      >
        <a-input v-model="state.form.newPassword" allowClear placeholder="请输入新密码"/>
      </a-form-item>
    </a-form>
