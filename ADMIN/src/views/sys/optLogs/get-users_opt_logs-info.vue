  ...
  <section class="zy-get">
    <a-form :model="state.form"
      ...
      <a-form-item label="操作人"
        ...
        <a-input v-model="state.form.operator" allowClear placeholder="请输入操作人"/>
      </a-form-item>
      ...
      <a-form-item label="操作模块"
        ...
        <a-input v-model="state.form.module" allowClear placeholder="请输入操作模块"/>
      </a-form-item>
      ...
      <a-form-item label="操作平台"
        ...
        <a-input v-model="state.form.platform" allowClear placeholder="请输入操作平台"/>
      </a-form-item>
      ...
      <a-form-item label="设备IP"
        ...
        <a-input v-model="state.form.operatorIP" allowClear placeholder="请输入设备IP"/>
      </a-form-item>
      ...
      <a-form-item label="设备位置"
        ...
        <a-input v-model="state.form.address" allowClear placeholder="请输入设备位置"/>
      </a-form-item>
      ...
      <a-form-item label="操作内容"
                   name="content"
                  >
        <a-input v-model="state.form.content" allowClear placeholder="请输入操作内容"/>
      </a-form-item>
