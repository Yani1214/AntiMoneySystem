  ...
  <section>
    ...
    >
      ...
      <a-form-item name="module">
        <a-input v-model="state.query.params.module" allowClear
                 placeholder="请输入操作模块" @pressEnter="goPage"
                 autocomplete="off"/>
      </a-form-item>

      <a-form-item name="platform">
        <a-input v-model="state.query.params.platform" allowClear
                 placeholder="请输入操作平台" @pressEnter="goPage"
                 autocomplete="off"/>
      </a-form-item>
      <a-form-item name="operatorIP">
        <a-input v-model="state.query.params.operatorIP" allowClear
