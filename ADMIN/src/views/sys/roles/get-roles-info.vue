<template>
  <section class="zy-get">
    <a-form :model="state.form" ref="formRef" class="zy-form" :label-col="labelCol" :wrapper-col="wrapperCol">
      ...
      >
        <a-input v-model="state.form.roleName" allowClear placeholder="请输入角色名称"/>
      </a-form-item>
      <a-form-item label="角色标识"
                   name="roleAuth"
                   :rules="[{ required: true, message: '请输入角色标识!' }]"
      >
        <a-input v-model="state.form.roleAuth" disabled allowClear placeholder="请输入角色标识"/>
      </a-form-item>
      <a-form-item label="角色备注" name="remark">
        <a-textarea v-model="state.form.remark"  allowClear placeholder="请输入角色备注"/>
      </a-form-item>
      ...
      <a-form-item label="菜单权限" name="perms"
        ...
        <ZyPermTree v-model="state.form.perms"/>
      </a-form-item>
    </a-form>
