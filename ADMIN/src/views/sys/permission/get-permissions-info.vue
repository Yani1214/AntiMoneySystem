    ...
    <section class="zy-get">
        ...
        <a-form :model="state.form"
            ...
            <a-form-item label="权限名称"
                ...
                <a-input v-model="state.form.name" allowClear placeholder="权限名称：增加"/>
            </a-form-item>

            <a-form-item label="权限标识"
                         name="key"
                         :rules="[{ required: true, message: '请输入权限标识!' }]">
                <a-input v-model="state.form.key" allowClear placeholder="权限标识：sys:user / sys:user:create"/>
            </a-form-item>

            <a-form-item label="父级标识"
                         name="parent_key">
                <a-input v-model="state.form.parent_key" allowClear placeholder="父级标识：sys"/>

            </a-form-item>
            <a-form-item label="排序"
                         name="sortOrder">
                <a-input v-model="state.form.sortOrder" allowClear placeholder="排序:值越大越往后"/>

            </a-form-item>

            <a-form-item label="权限按钮"
                         name="auth">
                <a-radio-group v-model="state.form.auth" name="auth">
          ...
          <a-form-item label="生成子级"
                         name="autoSon">
                <a-radio-group v-model="state.form.autoSon" name="auth">
                    <a-radio :value="true">是</a-radio>
                    <a-radio :value="false">否</a-radio>
                </a-radio-group>
