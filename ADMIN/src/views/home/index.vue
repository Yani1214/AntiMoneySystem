<template>
  <section class="zy-container">
    ...
    <section class="one">
      <header class="major">
        <h1>欢迎使用反洗钱追踪溯源系统！</h1>
        <p class="sub-title">请点击<a href=#upload>上传文件</a>以批量上传需要检测的文件</p>
        <p>上传成功后，点击<a href=#upload>开始检测</a>以进行数据分析</p>
        ...
        <a href="https://z568_568.gitee.io/vue3-antd-plus" target="_blank">
          <a-button type="dashed">开始检测</a-button>
        </a>
      </header>
    </section>
    <section class="intro">
